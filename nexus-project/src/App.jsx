...
function StudentView({ user, onLogout }) {
  ...
  // ✅ FIX: getMisiones sin docente_id para que el API devuelva TODAS las misiones.
  // El filtro por grado se aplica en el frontend segun el grado del estudiante.
  // Esto permite que cualquier docente publique misiones para este grado.
  useEffect(()=>{
    getMisiones("","student").then(m=>{
